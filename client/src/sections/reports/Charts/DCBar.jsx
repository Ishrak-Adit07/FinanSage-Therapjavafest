...
const DCBar = ({ totalCredit, totalWithdrawal, subHead }) => {
  return (
    <div className="layoutSection pb-4 mt-40 align-center items-center justify-center">
      <h1 className="text-slate-900 text-4xl text-center">Transaction Comparison</h1>
      ...
      >
        ...
        >
          <div className="">
            <StraightAnglePieChart headerText={"Credit-Withdraw Bar Graph"} />
          </div>
        </motion.div>
