        ...
        >
          <div className='flex flex-col items-center lg:items-start'>
            ...
            <div className='flex items-center justify-center gap-5 mt-6 w-full lg:justify-start'>
              <Subscribe text={"Download CV"} onClickAction={handldeDownload}/>
              <Subscribe text={"Let's talk"} onClickAction={handldeDownload} />
            </div>
          </div>
        </motion.div >
        ...
        >
          <div className='flex justify-center max-w-xl'>
            {/* <a href="https://www.facebook.com/ishrak.adit"> */}
                <img src={HeroImage} alt='Ishrak Adit' className='w-1/2 h-auto object-cover rounded-full shadow-lg mt-20' />
            {/* </a> */}
          </div>
        </motion.div >
      </motion.div>
